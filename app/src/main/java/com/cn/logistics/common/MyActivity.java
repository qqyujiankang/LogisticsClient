...
import com.cn.logistics.bean.UserBean;
...
public abstract class MyActivity extends BaseActivity
    ...
    private static RegisterBean.DataBean bean;
    ...
    public boolean isLogin() {
        return SPUtils.contains("bean");
    }

    public static RegisterBean.DataBean userBean(){

        if (SPUtils.contains("bean")) {
            bean = new Gson().fromJson(SPUtils.getString("bean", ""), RegisterBean.DataBean.class);
            return bean;
        } else {
            return new RegisterBean.DataBean();
        }
