package com.cn.logistics.common;
...
import com.cn.logistics.BuildConfig;
import com.cn.logistics.other.EventBusManager;
import com.cn.logistics.utils.GlideImageLoader;
...
public final class MyApplication extends Application {
    ...
    public void onCreate() {
        super.onCreate();
        Unicorn.init(this, "f2da4eb93eed049bc4b0629e523f77e8", options(), new GlideImageLoader(this));
        initSDK(this);
    }
...
//        MultiDex.install(this);
    ...
    // 网易七鱼客服系统  如果返回值为null，则全部使用默认参数。
    private YSFOptions options() {
        YSFOptions options = new YSFOptions();
        options.statusBarNotificationConfig = new StatusBarNotificationConfig();

        options.uiCustomization = new UICustomization();
//        options.uiCustomization.buttonBackgroundColorList = R.color.textOrage;255  181  5

        options.uiCustomization.titleBarStyle = 0;
        options.uiCustomization.titleBackgroundResId = 0xFFDCF2F5;

        options.uiCustomization.topTipBarBackgroundColor = 0xFFDCF2F5;
        options.uiCustomization.topTipBarTextColor = 0xFF4E97D9;
