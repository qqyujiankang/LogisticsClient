...
public interface FileOperationBiz {
    ...
    void uploadMultipleFileDataRequest(Activity context,Map<String, Object> info, String fileKey, Map<String, File> paramsMap, String url, OnFileListener requestListener);
