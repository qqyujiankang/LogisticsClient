...
import com.cn.logistics.other.AppConfig;
...
public final class SplashActivity extends MyActivity
    ...
    protected void onRestart() {
        ...
        if (XXPermissions.isHasPermission(SplashActivity.this, Permission.Group.STORAGE)
                &&XXPermissions.isHasPermission(SplashActivity.this, Permission.Group.LOCATION)
                &&XXPermissions.isHasPermission(SplashActivity.this, str)
                &&XXPermissions.isHasPermission(SplashActivity.this, Permission.CALL_PHONE)) {
